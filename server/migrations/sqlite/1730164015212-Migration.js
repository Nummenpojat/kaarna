...
module.exports = class Migration1730164015212 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`DROP INDEX "IX_Meeting_LatestTentativeOrScheduledDate"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_0beec42f1ce51d531b8f5dbf22" ON "Meeting" ("CreatorID") WHERE CreatorID IS NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_01558a596149f278e2d30bd6d5" ON "Meeting" ("Slug") `);
        await queryRunner.query(`CREATE INDEX "IX_Meeting_LatestTentativeOrScheduledDate" ON "Meeting" ("null") `);
    }
}
